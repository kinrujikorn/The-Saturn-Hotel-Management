...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="header-configure-area">
            <a href="./login-register.php" class="bk-btn">Register Now</a>
        </div>
        ...
        <!-- <div class="top-nav">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="tn-right">
                            <a href="./login-register.html" class="bk-btn">Login/Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-10">
                        <div class="nav-menu">
                            ...
                            <div class="nav-right search-switch">
                                <i class="icon_search"></i>
                                <i class="tn-right"><a href="./login-register.php" class="bk-btn">Login/Register Now</a></i>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div style="display: flex; flex-direction: column; justify-content: center; align-content: center;">
        ...
        <section class="room-details-section spad">
            <div class="container">
                <div class="row">
                    <div>
                        <div class="room-details-item" style="display: block;margin-left:auto;margin-right:auto;width:70%">
