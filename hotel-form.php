...
<body>
                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    ...
                                    <li class="active"><a href="./hotel-form.php">Hotel Form</a></li>
                                    
                                    <li ><a href="./room-form.php">Room Form</a></li>
                                    <li ><a href="./room-form.php">Room Type Form</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <div>
        ...
        <div>
        <!-- form -->
        <form name="inpfrm" method="post" action="InsertHotel.php">
        <div class="container">
            <div class="col-lg-20 offset-lg-0">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" placeholder="Enter Your Address" name="hoteladdress" required>
                    </div>
                    <div class="col-lg-6">
                        <label for="HotelEmail"><b>Hotel Email</b></label>
                        <input type="text" placeholder="Enter Hotel Email" name="hotelemail" required>
                    </div>
                    <div class="col-lg-6">
                        <label for="HotelPhone"><b>Hotel Phone</b></label>
                        <input type="text" placeholder="Enter Hotel Phone" name="hotelphone" required>
                    </div>
                </div>
            </div>
