...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    <li class="active"><a href="./season-form.php">Season Form</a></li> 
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <div>
        ...
        <div>
                 <!-- form -->
        <form name="inpfrm" method="post" action="InsertSeason.php">
        <div class="container">
            <div class="col-lg-20 offset-lg-0">
                <div class="row">
                    <div class="col-lg-6">
                        <label for="SeasonName"><b>Season Name</b></label>
                        <input type="text" placeholder="Enter Season Name" name="seasonname" required>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <label for="SeasonDiscount"><b>Season Discount</b></label>
                        <input type="text" placeholder="Enter Season Discount" name="seasondiscount" required>
                    </div>
        ...
        <a href="./admin-seasons.php"><button type="button" class="cancelbtn">Back</button></a>
          <!-- <label>
